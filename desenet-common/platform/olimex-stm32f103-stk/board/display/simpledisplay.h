#ifndef SIMPLEDISPLAY_H_
#define SIMPLEDISPLAY_H_
...
public:
	...
	static const uint8_t COL_MAX = MonochromeDisplay::Height/MonochromeDisplay::LCD_LINE_HEIGHT - 1; 	///< Display's maximum column value
