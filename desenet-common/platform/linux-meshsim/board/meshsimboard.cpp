...
MeshSimBoard::MeshSimBoard() : QWidget( NULL ) , _ready( false ) , _displayEnabled( true ) , _ledState( false ) ,
...
bool MeshSimBoard::initialize()
{
	...
	if ( !_ready )
	{
		...
		_background.load(QApplication::applicationDirPath() +
						 __RESOURCE_PATH + "/resources/STM32F103-STK.png" );
		_led.load(QApplication::applicationDirPath() +
				  __RESOURCE_PATH + "/resources/STM32F103-STK-LEDON.png" );

		_joystick.load(QApplication::applicationDirPath() +
				   	   __RESOURCE_PATH + "/resources/STM32F103-STK-JOYSTICK.png" );
